...
type NumberToWords struct {
	XMLName xml.Name `xml:"http://www.dataaccess.com/webservicesserver/ NumberToWords" json:"-"`

	UbiNum uint64 `xml:"ubiNum,omitempty" json:"ubiNum,omitempty"`
}

type NumberToWordsResponse struct {
	XMLName xml.Name `xml:"http://www.dataaccess.com/webservicesserver/ NumberToWordsResponse" json:"-"`
...
type NumberToDollars struct {
	XMLName xml.Name `xml:"http://www.dataaccess.com/webservicesserver/ NumberToDollars" json:"-"`
